                ...
                <table class="table  table-hover">
                    ...
                    <tbody>
                        ...
                        if (empty($pendientes)) {
                            ...
                            foreach ($pendientes->result() as $col) {
                        ?>
                                <form action="<?php echo base_url() ?>index.php/facturacion/MostrarDetallePedidosPendientes" method="POST" data-ajax="false">
                                    <tr>
                ...
                <div class="operaciones">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <h5 style="margin:12px">Eliminar pedido</h5><br>
