...
<body>
	...
	<div class="container-fluid">
										...
										<form action="<?php echo base_url() ?>index.php/Facturacion/MostrarDetalle" method="post" data-ajax="false">
											...
											<div class="card" id="Card">
												<div class="card-body" id="NumeroDeMesaCardBody">
													<h5 class="card-title"><?php echo $col->numpedido ?></h5>
												</div>
												...
												<div class="card-body" id="BotonImpreFactura">
													<button type="button"><img src="<?php echo base_url() ?>Imagenes/Factura.png" alt="">Comanda</button>
												</div>
											</div>
										</form>
				...
				<div class="operaciones">
					...
					<div class="form-row">
						<div class="col">
							...
							<h5 style="margin-top:4px">Cambio</h5>
							<h6 id="cambio"><b>$ </b></h6>

							<h6 style="color: red;margin-top:10px"><?php echo validation_errors(); ?></h6>
							<?php if (empty($Consecutivo) == false) { ?>

								<a data-toggle="modal" id="BotonPagar" data-target="#exampleConfirmarPago2" class="btn btn-block" role="button" aria-pressed="true">Pagar</a>

							<?php	} else {  ?>
								<a data-toggle="modal" id="BotonPagar" data-target="#exampleConfirmarPago2" class="btn btn-block disabled" role="button" aria-pressed="true">Pagar</a>
							<?php	} ?>
		...
		<div class="modal fade" id="exampleConfirmarPago2" tabindex="-1" role="dialog" aria-labelledby="exampleConfirmarPago" aria-hidden="true">
				...
				<form action="<?php echo base_url() ?>index.php/Mesero/AnularPedido" method="POST" data-ajax="false">
					<div class="modal-content">
						...
						<div class="modal-body">
							<h6> Se realizara el pago al pedido N:<?php echo $Consecutivo ?>, ¿Esta seguro? </h6>
							<div class="form-group">
								<select name="IDCategoria" class="form-control" id="TipoPago" required>
									<?php foreach ($TipoPago->result() as $rew) { ?>
										<option value="<?php echo ($rew->IdTiposPago); ?>"><?php echo ($rew->NombreTipo); ?></option>
									<?php } ?>
								</select>
							</div>
							<small>Se guarda el facturador y la fecha del pago</small>
						</div>
