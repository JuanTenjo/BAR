...
<body>
	...
	<div class="container">
		<div class="row">
		<div class="col-6">
			<img src="<?php echo base_url() ?>imagenes/logo.png" alt="Cielo Abierto" class="img-fluid"  width="100%">
		</div>
		<div class="col-6">
			<H1 class="SaludoAdministrador">Hola! Administrador <?php echo $Administrador ?></H1>
			<p id="textoParteDerechaAdmin">
