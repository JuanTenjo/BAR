...
class Model_Admin extends CI_Model
{
	...
	public function MostrarTipoPagos()
	{
		...
		FROM tiposdepago  order by NombreTipo asc");
		if ($query->num_rows() > 0) {
			return $query;
		} else {
			false;
	...
	public function RegistrarTipoPago($array){
		$query = "INSERT INTO tiposdepago(NombreTipo,NumCuenta) VALUES('$array[NombreTipo]','$array[NumCuenta]')";
		...
		if($bandera){
			...
			echo "Error al registrar el tipo de pago";
		}
			
	}
	public function ActualizarTipoPago($array = null){
		$query = "UPDATE tiposdepago 
		SET NombreTipo = '$array[NombreTipo]', NumCuenta = '$array[NumCuenta]', Habilitado = '$array[Habilitado]'
		 WHERE IdTiposPago =  '$array[IdTiposPago]' ";
