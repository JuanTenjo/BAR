...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2021 a las 00:26:34
...
(48, 'CL136', 'Adriana', 2, '1', '2021-05-21 08:32:35', 0, 0, NULL, NULL, 0, NULL, 'No ha sido anulada', NULL),
...
--
ALTER TABLE `detallepedido`
  MODIFY `iddetalle_pedidos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
