...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2021 a las 07:52:20
...
(1, 1, 'Prueba1', 'Prueba Ingre', 10, 2000),
(2, 2, 'Prueba2', 'Prueba 2', 10, 3000),
(4, 0, 'dfg', 'dfg', 234, 234),
(5, 1, 'asdasd', 'asdasdqw1223', 23, 23333),
(6, 4, 'qwe', 'qwe', 123, 123),
(7, 4, 'Chingon', 'papa yuca arroz', 10, 13000);
...
INSERT INTO `productos` (`id`, `tipo`, `nombre`, `precio`) VALUES
(3, 'Comida', 'Prueba', '40999'),
(4, 'Bebidas', 'hit', '2000'),
(5, 'Almuerzos', 'Corriente', '10000'),
(6, 'Hamburguesas', 'Terruño', '8000'),
(7, 'Hamburguesas', 'Chingon', '11000'),
(8, '', '', '');
...
--
ALTER TABLE `mesas`
  MODIFY `idmesas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `zonas`
  MODIFY `idzonas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
